package com.example.springbootbase.chapter5_database.handler;

import com.example.springbootbase.chapter5_database.enumeration.BaseEnum;
...
//        }
    ...
    public E getNullableResult(ResultSet resultSet, String columnName) throws SQLException {
        Object code=resultSet.getObject(columnName);
    ...
    public E getNullableResult(CallableStatement callableStatement, int columnIndex) throws SQLException {
        Object code=callableStatement.getObject(columnIndex);
